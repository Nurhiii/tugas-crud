    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index.php" class="brand-link">
                <img src="assets/img/upg.png" alt="Logo upg" class="brand-image img-circle elevation-3" style="opacity: .8">
                <span class="brand-text font-weight-light">Tugas <small>WEB II</small></span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        ...
                        ?>
                        <img src="<?= $foto_path . $foto_name; ?>" class="img-circle elevation-2" alt="User Image">
                    </div>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <?php if (isset($_SESSION['level']) && ($_SESSION['level'] == 1 or $_SESSION['level'] == 2)) : ?>
                            <li class="nav-item">
                        ...
                        <?php if (isset($_SESSION['level']) && ($_SESSION['level'] == 1 or $_SESSION['level'] == 4)) : ?>
                            <li class="nav-item">
                                <a href="mahasiswa.php" class="nav-link">
